...
class UNext(nn.Module):
    ...
    def __init__(self, num_classes=2, input_channels=3, deep_supervision=False, img_size=1024, patch_size=512,
                 ...
                 num_heads=[1, 2, 4, 8], mlp_ratios=[8, 8, 8, 8], qkv_bias=False, qk_scale=None, drop_rate=0.,
...
class UNext_S(nn.Module):
    ...
    def __init__(self, num_classes=2, input_channels=3, deep_supervision=False, img_size=1024, patch_size=1024,
                 in_chans=3, embed_dims=[32, 64, 128, 512],
